...
{
    var yemek = _context.Yemek.FirstOrDefault(y => y.Id == id);
    if (yemek == null)
    {
        return NotFound(); // Yemek bulunamazsa uygun bir hata döndürülüyor.
    }

    return View(yemek); // Yemeğin detayları view'e gönderiliyor.
}
